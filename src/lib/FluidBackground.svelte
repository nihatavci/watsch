...
<style global>
	...
	.fluid-background::after {
		...
		width: 200vmax;
		height: 200vmax;
		background: radial-gradient(circle at 50% 50%, rgba(229, 9, 20, 0.9) 0%, transparent 40%);
	...
	.fluid-background::after {
		...
		background: radial-gradient(circle at 50% 50%, rgba(9, 100, 229, 0.9) 0%, transparent 40%);
	}
